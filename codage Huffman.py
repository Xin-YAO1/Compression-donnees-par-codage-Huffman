...
if __name__ == '__main__':
    ...
    x=open_text_et_count_carac("alice.txt")
    ...
    t= z.codage({},'')
    nb_carac_total_text = get_nb_carac_total_text("alice.txt")
    ...
    compress("alice.txt","alice_compre.bin")
    cree_fichier_carac_freq("alice.txt","alice_freq.txt")
