...
class HuffmanTree(BNode):
    ...
    def codage(self,dic_code,code):
        ...
        #parcourir l'arbre jusqu'a le node est une feuill
        #si ce noed est une feuill, noter le code dans le dictionnaire
...
def compress(txt,outputfilename):
    ...
    '''compress quatre partie: 1.le somme de different carac dans le texte 
    ...
    # car chaque octet a 8 bits, si il y a des code superieur a 8 bit, on doit le separer par 8
    code_traite = ''
    ...
    #ecrire il reste combien element de code_traite dans fichier.bin
...
if __name__ == '__main__':
    ...
    x=open_text_et_count_carac("textesimple.txt")
    ...
    t= z.codage({},'')
    nb_carac_total_text = get_nb_carac_total_text("textesimple.txt")
    ...
    compress("textesimple.txt","textesimple_compre.bin")
    cree_fichier_carac_freq("textesimple.txt","textesimple_freq.txt")
